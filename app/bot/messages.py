...
def render_help() -> str:
    return "\n".join(
        [
            ...
            "",
            "/setup запускает настройку текущего чата. Если указан код заявки, направления и приоритеты берутся из списков РГРТУ. Если указан только балл, бот попросит направления в формате 01.03.02;1.",
            "",
